...
# 6.如何在应用代码中调用驱动
 ...
 |1|![images](https://github.com/yuchengstudio/PIC32MZEF/blob/master/APP_note/pictures/harmony_start_026.jpg)|在状态机的枚举类型中添加应用程序的“状态”，状态的定义根据应用程序的实际执行情况定义。在LED_Flash应用中无非就两个这状态：1.延时启动。2.延时完成【这个时候启动LED翻转】|
