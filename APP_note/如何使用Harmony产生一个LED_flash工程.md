...
# 6.如何在应用代码中调用驱动
 ...
 |6.2|![images](https://github.com/yuchengstudio/PIC32MZEF/blob/master/APP_note/pictures/harmony_start_032.jpg)|初始化的主函数在system_init.c这个文件里，这里包含了系统所有的初始化工作，包括harmony自动生成的，以及应用程序初始化的接口函数LED_FLASH_Initialize（）|
